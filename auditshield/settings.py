...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-auditshield-dev-key-2025-change-in-production')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'audits.context_processors.role_nav_context',
            ],
        },
    },
]
